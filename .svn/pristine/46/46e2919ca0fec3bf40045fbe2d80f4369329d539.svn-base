...
');
            ...
            $table->index(["AccChartID"], 'fk_researcher_account_chart1_idx');


            $table->foreign('AccChartID', 'fk_researcher_account_chart1_idx')
