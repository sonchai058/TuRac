...
<div class="form-group row">
    ...
    <div class="col-md-8">
        {!! Form::select('Type',['เดรดิต'=>'เดรดิต','เคบิต'=>'เคบิต'], null, ['class' => 'form-control']) !!}
        {{-- <span class="help-block">This is a help text</span> --}}
    </div>
</div>
...
<div class="form-group row">
    {!! Form::label('type1', 'ประเภท',['class'=>'col-md-4 col-form-label text-right']) !!}
    <div class="col-md-8">
        {!! Form::select('type1',[], null, ['class' => 'form-control']) !!}
        {{-- <span class="help-block">This is a help text</span> --}}
    </div>
</div>
